export module ties.meta.concepts;
...
namespace ties::meta::concepts::impl {
...
export namespace ties::meta::concepts {
  template<typename T1, typename T2>
  ...
  template<typename T>
  concept integral =
      same_types<meta::cast::remove_cv_qualifiers<T>, i8> or
      same_types<meta::cast::remove_cv_qualifiers<T>, u8> or
      same_types<meta::cast::remove_cv_qualifiers<T>, i16> or
      same_types<meta::cast::remove_cv_qualifiers<T>, u16> or
      same_types<meta::cast::remove_cv_qualifiers<T>, i32> or
      same_types<meta::cast::remove_cv_qualifiers<T>, u32> or
      same_types<meta::cast::remove_cv_qualifiers<T>, i64> or
      same_types<meta::cast::remove_cv_qualifiers<T>, u64> or
      same_types<meta::cast::remove_cv_qualifiers<T>, i128> or
      same_types<meta::cast::remove_cv_qualifiers<T>, u128>;

  template<typename T>
  concept floating_point =
      same_types<meta::cast::remove_cv_qualifiers<T>, f32> or
      same_types<meta::cast::remove_cv_qualifiers<T>, f64> or
      same_types<meta::cast::remove_cv_qualifiers<T>, f128>;
  ...
  concept signed_integral =
      ...
      same_types<meta::cast::remove_cv_qualifiers<T>, i32> or
      same_types<meta::cast::remove_cv_qualifiers<T>, i64> or
      same_types<meta::cast::remove_cv_qualifiers<T>, i128>;
  ...
  concept fundamental =
      integral<T> or
      floating_point<T> or
      same_types<meta::cast::remove_cv_qualifiers<T>, void> or
      same_types<meta::cast::remove_cv_qualifiers<T>, nullptr_t>;
  ...
  template<typename T>
  concept pointer = impl::pointer<meta::cast::remove_cv_qualifiers<T>>;
  ...
  concept object =
      not function<T> and
      not reference<T> and
      not same_types<meta::cast::remove_cv_qualifiers<T>, void>;
  ...
  template<typename T>
  concept incomplete = requires(meta::cast::remove_cv_qualifiers<T> val) {
  ...
  concept trivially_destructible =
      not same_types<meta::cast::remove_cv_qualifiers<T>, void> and
  ...
  template<typename T>
  concept copy_constructible = constructible<T, meta::cast::add_lvalue_reference<const T>>;

  template<typename T>
  concept trivially_copy_constructible =
      trivially_constructible<T, meta::cast::add_lvalue_reference<const T>>;

  template<typename T>
  concept move_constructible = constructible<T, meta::cast::add_rvalue_reference<T>>;

  template<typename T>
  concept trivially_move_constructible =
      trivially_constructible<T, meta::cast::add_rvalue_reference<T>>;
  ...
  concept copy_assignable =
      assignable<meta::cast::add_lvalue_reference<T>, meta::cast::add_lvalue_reference<const T>>;

  template<typename T>
  concept trivially_copy_assignable =
      trivially_assignable<meta::cast::add_lvalue_reference<T>, meta::cast::add_lvalue_reference<const T>>;

  template<typename T>
  concept move_assignable =
      assignable<meta::cast::add_lvalue_reference<T>, meta::cast::add_rvalue_reference<T>>;

  template<typename T>
  concept trivially_move_assignable =
      trivially_assignable<meta::cast::add_lvalue_reference<T>, meta::cast::add_rvalue_reference<T>>;
}
